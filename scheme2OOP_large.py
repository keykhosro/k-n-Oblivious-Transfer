...
class Sender:
    def __init__(self,G, num, n):
        self.num = num
        self.n = n
        self.g = G
        self.bulletin, self.alpha = self.sender_setup(self.g, self.n,self.num)

    def sender_step1(self, M, R1, k):
        self.r, self.C, self.S1 = self.sender_step1_helper(self.bulletin, self.num, M, R1, k, self.n)
        return self.r, self.C, self.S1

    def sender_setup(self, G, n, num):
    ...
    def sender_step1_helper(self, bulletin, num, M, R1, k, n):
